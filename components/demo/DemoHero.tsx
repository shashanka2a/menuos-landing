    ...
    <section className="relative pt-32 pb-24 lg:pt-40 overflow-hidden">
      ...
      <div className="text-center max-w-7xl mx-auto px-6 relative z-10">
        <ScrollAnimate animationType="fade-up" delay={0}>
          <h1 className="bg-clip-text text-transparent bg-gradient-to-b from-slate-900 to-slate-600 text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.1] max-w-4xl mx-auto mb-6">
            See MenuOS in Action
          </h1>
        </ScrollAnimate>
        
        <ScrollAnimate animationType="fade-up" delay={100}>
          <p className="leading-relaxed text-lg sm:text-xl text-slate-600 max-w-3xl mx-auto mb-10 font-medium">
        ...
        <ScrollAnimate animationType="fade-up" delay={300}>
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 bg-orange-600 text-white text-base font-semibold px-8 py-3.5 rounded-full hover:bg-orange-700 transition-all shadow-xl shadow-orange-600/20 hover:shadow-orange-600/30 hover:-translate-y-0.5 disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {isLoading ? (
              <>
